        ...
        <main className="mx-auto max-w-3xl px-6 py-12">
          ...
          <section className="mt-8 space-y-8">
            <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-white/[0.08] dark:bg-white/[0.03]">
              ...
              <div className="mt-4">
                <a href="mailto:jobs@aidly.me?subject=Backend%20Developer%20Application" className="text-[#3872B9] underline hover:text-[#B33275]">Apply via email</a>
              </div>
            </div>
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-white/[0.08] dark:bg-white/[0.03]">
              ...
              <div className="mt-4">
                <a href="mailto:jobs@aidly.me?subject=Business%20Developer%20Application" className="text-[#3872B9] underline hover:text-[#B33275]">Apply via email</a>
              </div>
            </div>

            <div className="text-sm text-slate-500 dark:text-white/50">
              Don&apos;t see a fit? Send us a note at <a href="mailto:jobs@aidly.me" className="text-[#3872B9] underline hover:text-[#B33275]">jobs@aidly.me</a>.
            </div>
          </section>
        </main>
