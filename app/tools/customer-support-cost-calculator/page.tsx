...
export const metadata: Metadata = {
  ...
  description: "Free customer support cost calculator. Calculate your team's total costs, cost per ticket, and potential savings with AI. Industry benchmarks included.",
  keywords: [
