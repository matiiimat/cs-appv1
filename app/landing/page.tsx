...
export default function LuxuryLanding() {
  ...
  const testimonials = [
    {
      quote: "What used to take my team 4 hours daily now takes 20 minutes. The quality is actually better because we can focus on the complex cases.",
      author: "Jean-Pierre L.",
      role: "Founder",
      company: "Braceletsdemontre.com"
    },
    {
      quote: "We went from 24-hour response times to under 2 hours. Customer satisfaction jumped 40% in the first month.",
      author: "Sarah M.",
      role: "Head of Support",
      company: "TechFlow SaaS"
    },
    {
      quote: "Finally, an AI tool that doesn't feel like a robot. Our customers can't tell the difference between AI drafts and human responses.",
      author: "Marcus T.",
      role: "CEO",
